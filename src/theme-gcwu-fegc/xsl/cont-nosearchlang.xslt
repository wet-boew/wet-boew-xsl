...
&lt;li id="gcwu-gcnb3"&gt;&lt;a rel="external" href="http://www.canada.gc.ca/depts/major/depind-eng.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-depts']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/li&gt;</xsl:when>
...
&lt;li id="gcwu-gcnb3"&gt;&lt;a rel="external" href="http://www.canada.gc.ca/depts/major/depind-fra.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-depts']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/li&gt;</xsl:when>
</xsl:choose>
&lt;/ul&gt;
&lt;/div&gt;&lt;/div&gt;&lt;/div&gt;&lt;/nav&gt;
