...
&lt;ul&gt;
<xsl:choose>
	<xsl:when test="lang('en')">&lt;li&gt;&lt;a href="home-accueil-eng.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-home']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/li&gt;</xsl:when>
	<xsl:when test="lang('fr')">&lt;li&gt;&lt;a href="home-accueil-fra.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-home']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/li&gt;</xsl:when>
	<xsl:otherwise>&lt;li&gt;&lt;a href="home-accueil-<xsl:value-of select="./@xml:lang"/>.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-home']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/li&gt;</xsl:otherwise>
</xsl:choose>
