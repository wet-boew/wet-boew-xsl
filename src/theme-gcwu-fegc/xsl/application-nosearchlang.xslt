...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="root" select="'application-nosearchlang'"/>
...
<xsl:choose>
	<xsl:when test="lang('en')">&lt;ul&gt;
&lt;li id="gcwu-gcnb1"&gt;&lt;a target="_blank" rel="external" href="http://www.canada.gc.ca/home.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-gc-ca']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/li&gt;
...
&lt;/ul&gt;</xsl:when>
	<xsl:when test="lang('fr')">&lt;ul&gt;
&lt;li id="gcwu-gcnb1"&gt;&lt;a target="_blank" rel="external" href="http://www.canada.gc.ca/accueil.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-gc-ca']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/li&gt;
...
&lt;li&gt;<xsl:value-of select="/strings/string[@id='%tmpl-web-application']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$hyphen"/><xsl:value-of select="/strings/string[@id='%tmpl-nosearchlang']/value[lang(current()/@xml:lang)]"/>&lt;/li&gt;
&lt;/ol&gt;
&lt;/div&gt;&lt;/div&gt;
&lt;/nav&gt;
&lt;!-- HeaderEnd --&gt;
