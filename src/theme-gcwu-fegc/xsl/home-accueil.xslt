...
&lt;li&gt;&lt;img src="<xsl:value-of select="$path_correction"/>images/prio2.png" width="220" height="70" alt="<xsl:value-of select="/strings/string[@id='%tmpl-priority']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>2" title="<xsl:value-of select="/strings/string[@id='%tmpl-priority']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>2" /&gt;&lt;/li&gt;
&lt;li&gt;&lt;img src="<xsl:value-of select="$path_correction"/>images/prio3.png" width="220" height="70" alt="<xsl:value-of select="/strings/string[@id='%tmpl-priority']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>3" title="<xsl:value-of select="/strings/string[@id='%tmpl-priority']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>3" /&gt;&lt;/li&gt;
&lt;/ul&gt;
&lt;/div&gt;&lt;/div&gt;&lt;/section&gt;
