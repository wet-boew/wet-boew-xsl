...
&lt;/section&gt;&lt;/li&gt;
&lt;li&gt;&lt;section&gt;&lt;h3&gt;&lt;a href="#"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-news']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>2&lt;/a&gt;&lt;/h3&gt;
&lt;p&gt;<xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>&lt;a href="#"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-read-more']/value[lang(current()/@xml:lang)]"/>&lt;span class="wb-invisible"&gt;<xsl:value-of select="/strings/string[@id='%hyphen']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-news']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>2&lt;/span&gt;&lt;/a&gt;&lt;/p&gt;
&lt;/section&gt;&lt;/li&gt;
&lt;li&gt;&lt;section&gt;&lt;h3&gt;&lt;a href="#"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-news']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>3&lt;/a&gt;&lt;/h3&gt;
&lt;p&gt;<xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>&lt;a href="#"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-read-more']/value[lang(current()/@xml:lang)]"/>&lt;span class="wb-invisible"&gt;<xsl:value-of select="/strings/string[@id='%hyphen']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-news']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>3&lt;/span&gt;&lt;/a&gt;&lt;/p&gt;
&lt;/section&gt;&lt;/li&gt;
&lt;/ul&gt;
&lt;/section&gt;&lt;/div&gt;
...
&lt;ul&gt;
&lt;li&gt;&lt;img src="images/prio1.png" width="220" height="70" alt="<xsl:value-of select="/strings/string[@id='%tmpl-priority']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>1" title="<xsl:value-of select="/strings/string[@id='%tmpl-priority']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>1" /&gt;&lt;/li&gt;
&lt;li&gt;&lt;img src="images/prio2.png" width="220" height="70" alt="<xsl:value-of select="/strings/string[@id='%tmpl-priority']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>2" title="<xsl:value-of select="/strings/string[@id='%tmpl-priority']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>2" /&gt;&lt;/li&gt;
&lt;li&gt;&lt;img src="images/prio3.png" width="220" height="70" alt="<xsl:value-of select="/strings/string[@id='%tmpl-priority']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>3" title="<xsl:value-of select="/strings/string[@id='%tmpl-priority']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>3" /&gt;&lt;/li&gt;
&lt;/ul&gt;
&lt;/div&gt;&lt;/div&gt;&lt;/section&gt;
