...
&lt;ul&gt;
<xsl:choose>
	<xsl:when test="lang('en')">&lt;li id="gcwu-gcnb1"&gt;&lt;a target="_blank" rel="external" href="http://www.canada.gc.ca/home.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-gc-ca']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/li&gt;
...
&lt;li id="gcwu-gcnb3"&gt;&lt;a target="_blank" rel="external" href="http://www.canada.gc.ca/depts/major/depind-eng.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-depts']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/li&gt;
&lt;li id="gcwu-gcnb-lang"&gt;&lt;a href="<xsl:value-of select="$path_correction"/><xsl:value-of select="$root"/>-fra.html" lang="fr"&gt;<xsl:value-of select="/strings/string[@id='%lang-native']/value[lang('fr')]"/>&lt;/a&gt;&lt;/li&gt;</xsl:when>
	<xsl:when test="lang('fr')">&lt;li id="gcwu-gcnb1"&gt;&lt;a target="_blank" rel="external" href="http://www.canada.gc.ca/accueil.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-gc-ca']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/li&gt;
...
&lt;li id="gcwu-gcnb3"&gt;&lt;a target="_blank" rel="external" href="http://www.canada.gc.ca/depts/major/depind-fra.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-depts']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/li&gt;
...
&lt;li&gt;&lt;div&gt;&lt;a target="_blank" href="section2/index-<xsl:value-of select="/strings/string[@id='%lang-code-iso-639-2']/value[lang($wet_fallback_language)]"/>.html"&gt;<xsl:value-of select="$tmpl-section"/><xsl:value-of select="$interword-space"/>2&lt;/a&gt;&lt;/div&gt;&lt;/li&gt;
&lt;li&gt;&lt;div&gt;&lt;a target="_blank" href="#"&gt;<xsl:value-of select="$tmpl-section"/><xsl:value-of select="$interword-space"/>3&lt;/a&gt;&lt;/div&gt;&lt;/li&gt;
&lt;li&gt;&lt;div&gt;&lt;a target="_blank" href="#"&gt;<xsl:value-of select="$tmpl-section"/><xsl:value-of select="$interword-space"/>4&lt;/a&gt;&lt;/div&gt;&lt;/li&gt;
&lt;li&gt;&lt;div&gt;&lt;a target="_blank" href="#"&gt;<xsl:value-of select="$tmpl-section"/><xsl:value-of select="$interword-space"/>5&lt;/a&gt;&lt;/div&gt;&lt;/li&gt;
&lt;/ul&gt;
&lt;/div&gt;&lt;/div&gt;&lt;/div&gt;&lt;/div&gt;
...
&lt;li&gt;<xsl:value-of select="/strings/string[@id='%tmpl-web-application']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$hyphen"/><xsl:value-of select="/strings/string[@id='%tmpl-sec-menu']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$interword-space"/>1&lt;/li&gt;
&lt;/ol&gt;
&lt;/div&gt;&lt;/div&gt;
&lt;/nav&gt;
&lt;!-- HeaderEnd --&gt;
...
&lt;li&gt;&lt;a target="_blank" rel="external" href="http://www.travel.gc.ca/index-eng.asp"&gt;&lt;span&gt;Travel&lt;/span&gt;&lt;br /&gt;travel.gc.ca&lt;/a&gt;&lt;/li&gt;
...
&lt;li id="gcwu-gcft-ca"&gt;&lt;div&gt;&lt;a target="_blank" rel="external" href="http://www.canada.gc.ca/home.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-gc-ca']/value[lang('en')]"/>&lt;/a&gt;&lt;/div&gt;&lt;/li&gt;</xsl:when>
...
&lt;li id="gcwu-gcft-ca"&gt;&lt;div&gt;&lt;a target="_blank" rel="external" href="http://www.canada.gc.ca/accueil.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-gc-ca']/value[lang('en')]"/>&lt;/a&gt;&lt;/div&gt;&lt;/li&gt;</xsl:when>
	<xsl:otherwise>&lt;li id="gcwu-gcft-ca"&gt;&lt;div&gt;&lt;a target="_blank" rel="external" href="http://www.canada.gc.ca/home.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-gc-ca']/value[lang('en')]"/>&lt;/a&gt;&lt;/div&gt;&lt;/li&gt;</xsl:otherwise>
</xsl:choose>
&lt;/ul&gt;
&lt;/div&gt;&lt;/div&gt;&lt;/div&gt;&lt;/nav&gt;
&lt;!-- FooterEnd --&gt;
