...
&lt;!-- MainContentStart --&gt;
&lt;h1 id="wb-cont"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-cont-page']/value[lang(current()/@xml:lang)]"/> - <xsl:value-of select="/strings/string[@id='%tmpl-sec-menu']/value[lang(current()/@xml:lang)]"/> 2 - <xsl:value-of select="/strings/string[@id='%tmpl-gcwu-theme']/value[lang(current()/@xml:lang)]"/>&lt;/h1&gt;
...
&lt;/ul&gt;&lt;/div&gt;
&lt;section&gt;&lt;h4&gt;&lt;a href="#"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-section']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@lang)]"/>4.1&lt;/a&gt;&lt;/h4&gt;
&lt;ul&gt;
...
&lt;/ul&gt;
&lt;/section&gt;
&lt;section&gt;&lt;h4&gt;&lt;a href="#"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-section']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@lang)]"/>4.2&lt;/a&gt;&lt;/h4&gt;
&lt;ul&gt;
...
&lt;/ul&gt;
&lt;/section&gt;
&lt;section&gt;&lt;h4&gt;&lt;a href="#"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-section']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@lang)]"/>4.4&lt;/a&gt;&lt;/h4&gt;
&lt;ul&gt;
