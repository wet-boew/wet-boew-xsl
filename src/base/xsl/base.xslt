...
&lt;div&gt;&lt;input name="checkbox" type="checkbox" id="data5" value="checkbox" /&gt;&#160;&lt;label for="data5"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-option']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/>1&lt;/label&gt;&#160;&#160;
&lt;input name="checkbox" type="checkbox" id="data6" value="checkbox" /&gt;&#160;&lt;label for="data6"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-option']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/>2&lt;/label&gt;&#160;&#160;
&lt;input name="checkbox" type="checkbox" id="data7" value="checkbox" /&gt;&#160;&lt;label for="data7"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-option']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/>3&lt;/label&gt;&#160;&#160;
&lt;input name="checkbox" type="checkbox" id="data8" value="checkbox" /&gt;&#160;&lt;label for="data8"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-option']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/>4&lt;/label&gt;&lt;/div&gt;
&lt;/fieldset&gt;
