...
&lt;div id="wet-bnr" role="banner" aria-ownsid="wet-subsite"&gt;&lt;div id="wet-bnr-in"&gt;
...
&lt;/div&gt;&lt;/section&gt;
&lt;/div&gt;
&lt;div id="wet-subsite" class="wet-subsite-1"&gt;
...
&lt;!-- MainContentStart --&gt;
&lt;h1 id="wb-cont"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-cont-page']/value[lang(current()/@xml:lang)]"/> - <xsl:value-of select="/strings/string[@id='%tmpl-sub-site']/value[lang(current()/@xml:lang)]"/> - <xsl:value-of select="/strings/string[@id='%tmpl-wet-theme']/value[lang(current()/@xml:lang)]"/>&lt;/h1&gt;
