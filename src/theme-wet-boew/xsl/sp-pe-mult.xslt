...
&lt;link rel="stylesheet" href="<xsl:value-of select="$path_correction"/>../../dist/theme-wet-boew/css/theme-sp-pe-ie-min.css" /&gt;
...
&lt;link rel="stylesheet" href="<xsl:value-of select="$path_correction"/>../../dist/theme-wet-boew/css/theme-sp-pe-min.css" /&gt;
