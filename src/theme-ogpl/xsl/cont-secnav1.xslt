...
&lt;link rel="stylesheet" href="<xsl:value-of select="$path_correction"/>../../dist/theme-ogpl/css/theme-ie-min.css" /&gt;
...
&lt;link rel="stylesheet" href="<xsl:value-of select="$path_correction"/>../../dist/theme-ogpl/css/theme-min.css" /&gt;
...
&lt;!-- HeaderStart --&gt;
&lt;section&gt;&lt;div id="ogpl-fullhd"&gt;&lt;h2&gt;<xsl:value-of select="/strings/string[@id='%tmpl-header-bar']/value[lang(current()/@xml:lang)]"/>&lt;/h2&gt;
&lt;div id="ogpl-fullhd-in"&gt;
&lt;ul&gt;
<xsl:choose>
	<xsl:when test="lang('en')">&lt;li id="ogpl-fullhd-lang"&gt;&lt;a href="<xsl:value-of select="$path_correction"/>es/<xsl:value-of select="$root"/>-es.html" lang="es"&gt;<xsl:value-of select="/strings/string[@id='%lang-native']/value[lang('es')]"/>&lt;/a&gt;&lt;/li&gt;
&lt;li id="ogpl-fullhd-lang-2"&gt;&lt;a href="<xsl:value-of select="$path_correction"/><xsl:value-of select="$root"/>-fra.html" lang="fr"&gt;<xsl:value-of select="/strings/string[@id='%lang-native']/value[lang('fr')]"/>&lt;/a&gt;&lt;/li&gt;
&lt;li id="ogpl-fullhd-lang-current"&gt;<xsl:value-of select="/strings/string[@id='%lang-native']/value[lang(current()/@xml:lang)]"/>&lt;/li&gt;</xsl:when>
	<xsl:when test="lang('fr')">&lt;li id="ogpl-fullhd-lang"&gt;&lt;a href="<xsl:value-of select="$path_correction"/>es/<xsl:value-of select="$root"/>-es.html" lang="es"&gt;<xsl:value-of select="/strings/string[@id='%lang-native']/value[lang('es')]"/>&lt;/a&gt;&lt;/li&gt;
&lt;li id="ogpl-fullhd-lang-current"&gt;<xsl:value-of select="/strings/string[@id='%lang-native']/value[lang(current()/@xml:lang)]"/>&lt;/li&gt;
&lt;li id="ogpl-fullhd-lang-2"&gt;&lt;a href="<xsl:value-of select="$path_correction"/><xsl:value-of select="$root"/>-eng.html" lang="en"&gt;<xsl:value-of select="/strings/string[@id='%lang-native']/value[lang('en')]"/>&lt;/a&gt;&lt;/li&gt;</xsl:when>
	<xsl:otherwise>&lt;li id="ogpl-fullhd-lang-current"&gt;<xsl:value-of select="/strings/string[@id='%lang-native']/value[lang(current()/@xml:lang)]"/>&lt;/li&gt;
&lt;li id="ogpl-fullhd-lang"&gt;&lt;a href="<xsl:value-of select="$path_correction"/><xsl:value-of select="$root"/>-fra.html" lang="fr"&gt;<xsl:value-of select="/strings/string[@id='%lang-native']/value[lang('fr')]"/>&lt;/a&gt;&lt;/li&gt;
&lt;li id="ogpl-fullhd-lang-2"&gt;&lt;a href="<xsl:value-of select="$path_correction"/><xsl:value-of select="$root"/>-eng.html" lang="en"&gt;<xsl:value-of select="/strings/string[@id='%lang-native']/value[lang('en')]"/>&lt;/a&gt;&lt;/li&gt;</xsl:otherwise>
</xsl:choose>
&lt;/ul&gt;
&lt;/div&gt;
&lt;/div&gt;&lt;/section&gt;
...
&lt;section role="search"&gt;&lt;div id="ogpl-srchbx"&gt;&lt;h2&gt;<xsl:value-of select="/strings/string[@id='%tmpl-search']/value[lang(current()/@xml:lang)]"/>&lt;/h2&gt;
&lt;form action="#" method="post"&gt;&lt;div id="ogpl-srchbx-in"&gt;
&lt;label for="ogpl-srch"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-search-site']/value[lang(current()/@xml:lang)]"/>&lt;/label&gt;&lt;input id="ogpl-srch" name="ogpl-srch" type="search" value="" size="27" maxlength="150" /&gt;
&lt;input id="ogpl-srch-submit" name="ogpl-srch-submit" type="submit" value="<xsl:value-of select="/strings/string[@id='%tmpl-search']/value[lang(current()/@xml:lang)]"/>" data-icon="search" class="button button-accent" /&gt;
&lt;/div&gt;&lt;/form&gt;
&lt;/div&gt;&lt;/section&gt;
&lt;/div&gt;&lt;/div&gt;

&lt;nav role="navigation"&gt;
&lt;div id="ogpl-psnb"&gt;&lt;h2&gt;<xsl:value-of select="/strings/string[@id='%tmpl-site-menu']/value[lang(current()/@xml:lang)]"/>&lt;/h2&gt;&lt;div id="ogpl-psnb-in"&gt;&lt;div class="wet-boew-menubar mb-mega"&gt;&lt;div&gt;
...
&lt;div id="ogpl-bc"&gt;&lt;h2&gt;<xsl:value-of select="/strings/string[@id='%tmpl-bcrumb']/value[lang(current()/@xml:lang)]"/>&lt;/h2&gt;&lt;div id="ogpl-bc-in"&gt;
&lt;ol&gt;
...
&lt;li&gt;&lt;a href="<xsl:value-of select="$path_correction"/>index-<xsl:value-of select="/strings/string[@id='%lang-code-iso-639-2']/value[lang($wet_fallback_language)]"/>.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-ogpl-theme']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/li&gt;
...
&lt;li&gt;<xsl:value-of select="/strings/string[@id='%tmpl-cont-page']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$hyphen"/><xsl:value-of select="/strings/string[@id='%tmpl-sec-menu']/value[lang(current()/@xml:lang)]"/> 1&lt;/li&gt;
&lt;/ol&gt;
&lt;/div&gt;&lt;/div&gt;
&lt;/nav&gt;
&lt;!-- HeaderEnd --&gt;
...
&lt;dl id="ogpl-date-mod" role="contentinfo"&gt;
...
&lt;/ul&gt;&lt;/div&gt;
&lt;section&gt;&lt;h3&gt;&lt;a href="#"&gt;<xsl:value-of select="$tmpl-section"/><xsl:value-of select="$interword-space"/>4.1&lt;/a&gt;&lt;/h3&gt;
&lt;ul&gt;
...
&lt;/ul&gt;
&lt;/section&gt;
&lt;section&gt;&lt;h3&gt;&lt;a href="#"&gt;<xsl:value-of select="$tmpl-section"/><xsl:value-of select="$interword-space"/>4.2&lt;/a&gt;&lt;/h3&gt;
&lt;ul&gt;
...
&lt;/ul&gt;
&lt;/section&gt;
&lt;section&gt;&lt;h3&gt;&lt;a href="section4/section43/index-<xsl:value-of select="/strings/string[@id='%lang-code-iso-639-2']/value[lang($wet_fallback_language)]"/>.html"&gt;<xsl:value-of select="$tmpl-section"/><xsl:value-of select="$interword-space"/>4.3&lt;/a&gt;&lt;/h3&gt;
&lt;ul&gt;
...
&lt;/ul&gt;
&lt;/section&gt;
&lt;section&gt;&lt;h3&gt;&lt;a href="#"&gt;<xsl:value-of select="$tmpl-section"/><xsl:value-of select="$interword-space"/>4.4&lt;/a&gt;&lt;/h3&gt;
&lt;ul&gt;
...
&lt;!-- FooterStart --&gt;
&lt;nav role="navigation"&gt;&lt;div id="ogpl-sft"&gt;&lt;h3&gt;<xsl:value-of select="/strings/string[@id='%tmpl-site-foot']/value[lang(current()/@xml:lang)]"/>&lt;/h3&gt;&lt;div id="ogpl-sft-in"&gt;
&lt;section&gt;&lt;div class="span-2"&gt;&lt;h4 class="ogpl-col-head"&gt;&lt;a href="#"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-about-us']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/h4&gt;
&lt;ul&gt;
...
&lt;/ul&gt;
&lt;/div&gt;&lt;/section&gt;
&lt;section&gt;&lt;div class="span-2"&gt;&lt;h4 class="ogpl-col-head"&gt;&lt;a href="#"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-contact-us']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/h4&gt;
&lt;address&gt;
&lt;ul&gt;
...
&lt;/address&gt;
&lt;/div&gt;&lt;/section&gt;
&lt;section&gt;&lt;div class="span-2"&gt;&lt;h4 class="ogpl-col-head"&gt;&lt;a href="#"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-news']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/h4&gt;
&lt;ul&gt;
...
&lt;/ul&gt;
&lt;/div&gt;&lt;/section&gt;
&lt;section&gt;&lt;div class="span-2"&gt;&lt;h4 class="ogpl-col-head"&gt;&lt;a href="#"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-stay-connected']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/h4&gt;
&lt;ul&gt;
