...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="root" select="'cont-subsite'"/>
...
&lt;div id="ogpl-bnr" role="banner" aria-ownsid="ogpl-subsite"&gt;&lt;div id="ogpl-bnr-in"&gt;
...
&lt;/div&gt;&lt;/section&gt;
&lt;/div&gt;
&lt;div id="ogpl-subsite" class="ogpl-subsite-1"&gt;
&lt;p&gt;&lt;a href="#"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-sub-site-name']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/p&gt;
&lt;/div&gt;&lt;/div&gt;
...
&lt;li&gt;<xsl:value-of select="/strings/string[@id='%tmpl-cont-page']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="$hyphen"/><xsl:value-of select="/strings/string[@id='%tmpl-sub-site']/value[lang(current()/@xml:lang)]"/>&lt;/li&gt;
&lt;/ol&gt;
&lt;/div&gt;&lt;/div&gt;
&lt;/nav&gt;
&lt;!-- HeaderEnd --&gt;
