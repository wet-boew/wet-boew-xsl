...
&lt;link rel="stylesheet" href="<xsl:value-of select="$path_correction"/>../../dist/theme-ogpl/css/theme-sp-pe-ie-min.css" /&gt;
...
&lt;link rel="stylesheet" href="<xsl:value-of select="$path_correction"/>../../dist/theme-ogpl/css/theme-sp-pe-min.css" /&gt;
