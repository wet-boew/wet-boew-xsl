...
&lt;link rel="stylesheet" href="<xsl:value-of select="$path_correction"/>../../dist/theme-gcwu-intranet/css/theme-serv-ie-min.css" /&gt;
...
&lt;link rel="stylesheet" href="<xsl:value-of select="$path_correction"/>../../dist/theme-gcwu-intranet/css/theme-serv-min.css" /&gt;
...
&lt;div id="gcwu-wmms" class="span-4 row-end"&gt;&lt;div id="gcwu-wmms-in"&gt;&lt;object data="<xsl:value-of select="$path_correction"/>../../dist/theme-gcwu-intranet/images/wmms-blk.svg" role="img" tabindex="-1" aria-label="<xsl:value-of select="/strings/string[@id='%tmpl-gc-wmms']/value[lang(current()/@xml:lang)]"/>" type="image/svg+xml"&gt;&lt;img src="<xsl:value-of select="$path_correction"/>../../dist/theme-gcwu-intranet/images/wmms.png" class="image-actual" alt="<xsl:value-of select="/strings/string[@id='%tmpl-gc-wmms']/value[lang(current()/@xml:lang)]"/>" /&gt;&lt;/object&gt;&lt;/div&gt;&lt;/div&gt;
&lt;div class="clear"&gt;&lt;/div&gt;

<xsl:choose>
	<xsl:when test="lang('en') or lang('fr')">&lt;div id="gcwu-title-left" class="span-8 row-start row-end"&gt;&lt;a href="cont-<xsl:value-of select="/strings/string[@id='%lang-code-iso-639-2']/value[lang(current()/@xml:lang)]"/>.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-site-title']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/div&gt;</xsl:when>
	<xsl:otherwise>&lt;div id="gcwu-title-left" class="span-8 row-start row-end"&gt;&lt;a href="cont-<xsl:value-of select="./@xml:lang"/>.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-site-title']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/div&gt;</xsl:otherwise>
</xsl:choose>
&lt;div class="clear"&gt;&lt;/div&gt;
&lt;/div&gt;
&lt;!-- HeaderEnd --&gt;
...
&lt;div class="span-8"&gt;&lt;section&gt;&lt;h2&gt;<xsl:value-of select="/strings/string[@id='%tmpl-msg-title']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/>(h2)&lt;/h2&gt;
&lt;p&gt;<xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%interword-space']/value[lang(current()/@xml:lang)]"/><xsl:value-of select="/strings/string[@id='%tmpl-sample-text']/value[lang(current()/@xml:lang)]"/>.&lt;/p&gt;
&lt;ul&gt;
&lt;li&gt;&lt;a href="cont-<xsl:value-of select="/strings/string[@id='%lang-code-iso-639-2']/value[lang($wet_fallback_language)]"/>.html"&gt;<xsl:value-of select="/strings/string[@id='%tmpl-home']/value[lang(current()/@xml:lang)]"/>&lt;/a&gt;&lt;/li&gt;
